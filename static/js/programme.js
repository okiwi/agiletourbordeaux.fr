jQuery(document).ready(function () {
    ...
    var descriptions = {
		...
		'conf-morvant': '<h1>Découverte de l\'agilité de manière ludique : mindstorm4scrum</h1><p>Nous proposons ici de relever un challenge simple en construisant un robot qui est capable de mouvement. Les fonctionnels définiront les US, les développeurs/testeurs programmeront le robot et le construirons. Bien sur le tout, sans plan et en appliquant une méthode agile</p>'
    };
