jQuery(document).ready(function () {
    ...
    var descriptions = {
        ...
        'atelier-example-mapping': '<h1>Découvrir l\'example mapping par la pratique</h1>',
        ...
        'conf-leguedois':          '<h1>Cessons les estimations</h1>',
